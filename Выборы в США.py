...
голосов — число выборщиков от этого штата. На практике, все выборщики от штата голосуют в соответствии с
результатами голосования внутри штата, то есть на заключительной стадии выборов в голосовании участвуют штаты,
...
for line in file:
    line = line.split()
    if dictionary.get(line[0]) is None:
        dictionary[line[0]] = line[1]
    else:
        dictionary[line[0]] = int(dictionary.get(line[0])) + int(line[1])
